...
// Set 'active' class on the "كل الاعمال" button by default
const allWorksButton = document.querySelector('.fillter-buttons .btn[data-filter="all"]');
